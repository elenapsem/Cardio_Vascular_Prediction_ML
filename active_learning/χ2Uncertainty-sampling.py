...
X_raw = data.drop('cardio', axis=1).values
y_raw = data['cardio'].values
...
for index in range(N_QUERIES):
    ...
    x_final_dataset.append(X.tolist()[0])
    y_final_dataset.append(y.tolist()[0])
...
df.to_csv('uncertainty_dataset.csv', index=False, encoding='utf-8', sep=';')
